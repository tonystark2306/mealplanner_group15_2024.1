...
@general_api.route("/fridge/<group_id>", methods=["GET"])
@JWT_required
...
@general_api.route("/fridge/<group_id>", methods=["POST"])
@JWT_required
@group_member_required
...
@general_api.route("/fridge/<group_id>/<item_id>", methods=["GET"])
@JWT_required
@group_member_required
...
@general_api.route("/fridge/<group_id>", methods=["PUT"])
@JWT_required
@group_member_required
...
@general_api.route("/fridge/<group_id>/<item_id>", methods=["DELETE"])
@JWT_required
@group_member_required
